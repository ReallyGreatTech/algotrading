  ...
  return (
    <div className="p-10">
      ...
      <main className="bg-[#6558F5] text-white h-[80vh] mt-5 rounded-md">
        ...
        <section className="grid grid-cols-12 gap-4 h-[65vh] p-5 ">
          <div className="border col-span-full md:col-span-3 bg-[#F7C325] h-full rounded-md text-center">
          ...
          <div className="border col-span-full md:col-span-6  h-full rounded-md flex flex-col gap-4">
            <div className="bg-[#F7C325] h-1/2">
              ...
              <h2 className="text-center text-black font-bold">Funding history chart (from selected row in table)</h2>
            </div>
            <div className="bg-[#F7C325] h-1/2">
              {" "}
              <h2 className="text-center text-black font-bold"> Price chart (from selected row in table)</h2>
            </div>
          </div>
